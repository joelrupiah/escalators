...
<top-header v-if="!['AdminLogin', 'AdminReset'].includes($route.name)"></top-header>
    <!-- partial -->
<admin-header v-if="!['AdminLogin', 'AdminReset'].includes($route.name)"></admin-header>
    <div class="container-fluid page-body-wrapper">
      <!-- partial:partials/_settings-panel.html -->
<admin-skin v-if="!['AdminLogin', 'AdminReset'].includes($route.name)"></admin-skin>
...
<admin-sidebar v-if="!['AdminLogin', 'AdminReset'].includes($route.name)"></admin-sidebar>
      <!-- partial -->
      <div class="main-panel">
<router-view></router-view>
        <!-- content-wrapper ends -->
        <!-- partial:partials/_footer.html -->
<admin-footer v-if="!['AdminLogin', 'AdminReset'].includes($route.name)"></admin-footer>
        <!-- partial -->
      </div>
      <!-- main-panel ends -->
    </div>
...
<script>
import TopHeader from './inc/TopHeader.vue'
import AdminHeader from './inc/AdminHeader.vue'
import AdminSkin from './inc/AdminSkin.vue'
import AdminSidebar from './inc/AdminSidebar.vue'
import AdminFooter from './inc/AdminFooter.vue'
export default {
    name: 'AdminMaster',
    components: {
      TopHeader,
    ...
    mounted(){
        this.$store.commit('admin/LOGIN', !!localStorage.getItem('token'))
    }
}
</script>